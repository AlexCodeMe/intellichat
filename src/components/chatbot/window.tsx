...
import TabsMenu from '../custom/tabs-menu'
import { BOT_TABS_MENU } from '@/constants'
    ...
    (
        ...
        return (
            <div className="h-[670px] w-[450px] flex flex-col bg-white rounded-xl mr-[80px] border-[1px] overflow-hidden">
                ...
                <TabsMenu triggers={BOT_TABS_MENU}
                ...
                <div className="flex justify-center ">
                    <p className="text-gray-400 text-xs">Powered By Intellichat</p>
                </div>
            </div>
        )
    }
