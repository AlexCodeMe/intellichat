...
export default function CodeSnippet({ id }: { id: string }) {
    ...
    return (
        <div className="mt-10 flex flex-col gap-5 items-start">
            <div>
                ...
                <p className="text-sm font-light">Copy and paste this code snippet into the header tag of your website</p>
            </div>
            <div className="bg-cream px-10 rounded-lg inline-block relative">
                <Copy className="absolute top-5 right-5 text-gray-400 cursor-pointer"
                    onClick={() => {
