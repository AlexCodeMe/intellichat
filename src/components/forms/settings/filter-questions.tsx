...
export default function FilterQuestions({ id }: { id: string }) {
    const {
        register,
        errors,
                ...
                >
                    <div className="flex flex-col gap-3">
                        <div>
                            ...
                            <p className="text-sm font-light">Add a question that you want your chatbot to ask</p>
                        </div>
                        <FormGenerator
                            inputType="input"
                            register={register}
                    ...
                    <div className="flex flex-col gap-3">
                        <div>
                            <p className="text-sm font-medium">Answer to question</p>
                            <p className="text-sm font-light">The anwer for the question above</p>
                        </div>
                        <FormGenerator
                            inputType="textarea"
                            register={register}
