...
import AppDrawer from '../custom/app-drawer'
import UploadButton from '../custom/upload-button'
    ...
    return (
        <div className={cn('flex flex-col gap-3', min ? 'mt-6' : 'mt-3')}>
            <div className="flex justify-between w-full items-center">
                ...
                <AppDrawer title="Add your business domain"
            ...
            <div className="flex flex-col gap-1 text-ironside font-medium">
                {domains &&
                    domains.map((domain) => (
                        ...
                        >
                            <Image src={`https://ucarecdn.com/${domain.icon}/`}
                                alt="logo"
                                width={20} height={20}
                            />
